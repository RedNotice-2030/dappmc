...
<head>
  ...
  <style>
    ...
    .cms-sidebar .nav-link.active {
      background-color: rgba(198, 179, 80, 0.2);
      color: #c6b350;
    }
    ...
    .list-editor-item .btn-remove-item {
      flex-shrink: 0;
    }
    ...
    .login-screen {
      ...
      background: linear-gradient(135deg, #002c6d 0%, #001f52 100%);
      padding: 1rem;
    }
    ...
    .login-input:focus {
      border-color: #c6b350;
      box-shadow: 0 0 0 0.2rem rgba(198, 179, 80, 0.25);
    }
          ...
          <div class="p-4">
            ...
            <div id="panel-packages" class="cms-panel" style="display: none">
              <div class="cms-card">
                ...
                <div class="cms-card-body">
                  <div id="packages-items-list"></div>
                </div>
              </div>
            </div>
